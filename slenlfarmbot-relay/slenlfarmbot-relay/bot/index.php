...
function build_response($chat_id, $text) {
    $returnvalue = 'https://api.telegram.org/bot137761232:AAEtgDd29ojiyUWjU297zQBQUIP8IlOmgjE/sendMessage?chat_id='
            . $chat_id . '&text=' . $text;
    return $returnvalue;
}
function build_location_response($chat_id, $location) {
    $returnvalue = 'https://api.telegram.org/bot137761232:AAEtgDd29ojiyUWjU297zQBQUIP8IlOmgjE/sendLocation?chat_id='
